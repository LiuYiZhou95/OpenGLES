...
Java_com_opengles_nativeglesview_Render_MyRenderer_nativeInit(JNIEnv *env, jclass type,
...
JNIEXPORT void JNICALL
Java_com_opengles_nativeglesview_Render_MyRenderer_nativeDraw(JNIEnv *env, jclass type,
...
JNIEXPORT void JNICALL
Java_com_opengles_nativeglesview_Render_MyRenderer_nativeSurfaceChanged(JNIEnv *env, jclass type,
                                                                 jint width,
                                                                 jint height) {
